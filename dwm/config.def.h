...
static const char *fonts[]          = { "JetBrainsMonoNerdFont-Regular:size=16" };
static const char dmenufont[]       = "JetBrainsMonoNerdFont-Regular:size=16";
